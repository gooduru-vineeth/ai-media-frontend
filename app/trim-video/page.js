...
export default function TrimVideo() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://8zdhdl5q-8000.inc1.devtunnels.ms/api/trim-video', {
        method: 'POST',
        body: formData,
      });
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">Trim Video</h1>
      ...
      {trimmedVideoUrl && (
        <div className="mt-4">
          <h2 className="text-xl font-semibold mb-2">Trimmed Video:</h2>
          <video controls width="100%" src={trimmedVideoUrl}>
